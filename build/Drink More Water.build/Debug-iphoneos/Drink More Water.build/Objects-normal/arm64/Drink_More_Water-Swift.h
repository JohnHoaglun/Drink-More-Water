...
#ifndef DRINK_MORE_WATER_SWIFT_H
#define DRINK_MORE_WATER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Drink_More_Water",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Drink_More_Water20NotificationDelegate")
...
/// immediately when the user responds. The system’s <code>.sound</code>
/// presentation option cannot be cancelled once playing.
SWIFT_CLASS("_TtC16Drink_More_Water23NotificationSoundPlayer")
@interface NotificationSoundPlayer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
